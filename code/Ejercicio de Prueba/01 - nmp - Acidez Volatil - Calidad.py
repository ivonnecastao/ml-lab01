...
print('Variable Independiente X: Acidez Volatil')
print(x)
print(x.shape)

print('Variable Independiente X Transpuesta: Acidez Volatil')
x = np.transpose(x)
print(x)
print(x.shape)
...
print('Variable Independiente X + BIAS: BIAS Acidez Volatil')
print(x_b)
print(x_b.shape)
...
plt.show()
plt.savefig('plots\Acidezvolatil_vs_calidad_numpy.png')
...
plt.title('Regresión Lineal con Numpy')
plt.show()
plt.savefig('plots\y_vs_y_pred_avq_numpy.png')
#"""
