...
print('Variable Independiente X: Acidez Cítrica')
print(x)
print(x.shape)

print('Variable Independiente X Transpuesta: Acidez Cítrica')
x = np.transpose(x)
print(x)
print(x.shape)
...
print('Variable Independiente X + BIAS: BIAS Acidez Cítrica')
print(x_b)
print(x_b.shape)
...
plt.show()
plt.savefig('plots\Acidezcítrica_vs_calidad_numpy.png')
...
plt.title('Regresión Lineal con Numpy')
plt.show()
plt.savefig('plots\y_vs_y_pred_acq_numpy.png')
#"""
