...
print('Variable Independiente X: Azúcar Residual')
print(x)
print(x.shape)

print('Variable Independiente X Transpuesta: Azúcar Residual')
x = np.transpose(x)
print(x)
print(x.shape)
...
print('Variable Independiente X + BIAS: BIAS Azúcar Residual')
print(x_b)
print(x_b.shape)
...
plt.show()
plt.savefig('plots\AzúcarResidual_vs_calidad_numpy.png')
...
plt.title('Regresión Lineal con Numpy')
plt.show()
plt.savefig('plots\y_vs_y_pred_arq_numpy.png')
#"""
