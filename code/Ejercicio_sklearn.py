...
y_pred = model.predict(mnp_test)    # Este método se utiliza para realizar obtener las predicciones de un modelo sobre 
                                    # un conjunto de datos de entrada desconocidos. Es decir, una vez entrenado el modelo, 
                                    # se puede utilizar el método predict() saber los valores o etiquetas que asigna el 
